if(NOT DEFINED OPENOCD_PARAMS)
    message(FATAL_ERROR "OPENOCD_PARAMS is not defined.\n"
        "Example: \"set(OPENOCD_PARAMS -f interface/jlink.cfg transport select hla_swd -f target/rp2040.cfg)\"")
endif()
...
add_custom_target(erase
    COMMAND openocd ${OPENOCD_PARAMS} -c "init; halt; rp2040 mass_erase 0; exit"
    USES_TERMINAL
)
